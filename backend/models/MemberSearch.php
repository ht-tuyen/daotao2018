...
class MemberSearch extends Member
{
    ...
    public function rules()
    {
        return [
            ...
            [['fullname', 'username', 'password', 'salt', 'birthday', 'email', 'avatar', 'address', 'last_login', 'phone', 'mobile', 'created_at', 'created_by', 'updated_at', 'updated_by', 'last_login_time', 'about', 'token', 'time_token'], 'safe'],
        ];
    }
