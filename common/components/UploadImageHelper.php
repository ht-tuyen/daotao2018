...
class UploadImageHelper
{
    ...
    public function __construct($data, $itemName, $folder) {
        ...
        $this->imageName = $itemName. '.'.$file_extension;
        $file = Yii::getAlias('@anyname') . '/uploads/elearning/'.$folder.'/' . $this->imageName;
