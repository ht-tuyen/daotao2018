...
class Lesson extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'course_id', 'lesson_format', 'lesson_resource', 'thumbnail', 'short_desc', 'full_desc', 'attachments', 'state', 'ordering', 'created_by', 'modified_by'], 'required'],
            [['course_id', 'lesson_format', 'state', 'ordering', 'created_by', 'modified_by'], 'integer'],
            [['short_desc', 'full_desc', 'attachments'], 'string'],
