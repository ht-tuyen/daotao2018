        ...
        <div class="content-course-right">
            <div id="appquiz">
                ...
                <div class="result alert alert-success" v-if="showresult==1">
                    Chúc mừng bạn đã hoàn thành bài thi cuối khóa. Kết quả sẽ được cập nhật trong phần lịch sử học tập trong thời gian sớm nhất.
                </div>
...
var appquiz = new Vue({
    ...
    methods:{
        ...
        showResult: function() {
                axios.get('/api/elearning/quiz/showresult?id=' + this.quiz_result_id+'&quiz_id=<?php echo $item->quiz_id?>&quiz_type=2&item=<?php echo $item->course_id?>&quiz_name=<?php echo $item->name?>&itemname=')
                .then(response => {
                   this.showresult = 1;
